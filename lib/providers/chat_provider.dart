...
class ChatProvider extends ChangeNotifier{
  ...
  //to load all the current user chats
  ...
  // add the chat message when user send a new message to some one else

void addMessage(
    MessageModel message, String currentUser, List<UserData> users)async{
    try{ if(message.sender==currentUser){
...
void deleteMessage(
    MessageModel message, String currentUser) async{
    try{
